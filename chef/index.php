...
/*
            var categoryNames = [];
            var rows = document.querySelectorAll('#menu tr'); 
            rows.forEach(function(row) {

                var categoryCell = row.querySelector('.category');
                if (categoryCell) {

                    categoryNames.push(categoryCell.textContent);
                }
            });
